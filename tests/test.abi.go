...
func TestEncodeUint256Array10(value [10]*abi.Uint256, buf []byte) (int, error) {
	// Encode fixed-size array with static elements
...
func TestDecodeUint256Array10(data []byte) ([10]*abi.Uint256, int, error) {
	// Decode fixed-size array with static elements
	var (
		result [10]*abi.Uint256
		err    error
	)
	if len(data) < 320 {
		return result, 0, io.ErrUnexpectedEOF
...
func TestPackedEncodeUint256Array10(value [10]*abi.Uint256, buf []byte) (int, error) {
	if len(buf) < 320 {
		return 0, io.ErrShortBuffer
	}
	// Encode fixed-size array elements sequentially (no padding)
...
func TestPackedDecodeUint256Array10(data []byte) ([10]*abi.Uint256, int, error) {
	if len(data) < 320 {
		return [10]*abi.Uint256{}, 0, io.ErrUnexpectedEOF
	}
	var (
		result [10]*abi.Uint256
		offset int
